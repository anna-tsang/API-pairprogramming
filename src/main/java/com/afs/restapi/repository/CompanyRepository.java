...
public class CompanyRepository {
    ...
    public CompanyRepository(){
        ...
        employeeListOfCompanyB.add(new Employee (1,"Kandy",20,"F",5000,2));
        employeeListOfCompanyB.add(new Employee (2,"Raymon",20,"M",4000,2));
        companyList.add(new Company(2, "Bnnb Ltd", employeeListOfCompanyB));

        List<Employee> employeeListOfCompanyC = new ArrayList<>();
        employeeListOfCompanyC.add(new Employee (1,"Bnnb",20,"F",5000,3));
        employeeListOfCompanyC.add(new Employee (2,"Cnnc",20,"M",4000,3));
        employeeListOfCompanyC.add(new Employee (3,"Dnnd",20,"F",4000,3));
